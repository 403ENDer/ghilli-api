...
export class TeamsController {
  public static async getAllTeams(req: any, res: any) {
    try {
      ...
      return res
        .status(500)
        .send({ error: "Failed to fetch teams", details: error });
    }
  }
  ...
  public static async getTeam(req: any, res: any) {
    try {
      ...
      return res
        .status(500)
        .send({ error: "Failed to get team", details: error });
    }
  }

  public static async createTeam(req: any, res: any) {
    try {
      const data = createTeamValidator.safeParse(req.body).data;
      ...
      return res
        .status(500)
        .send({ error: "Failed to create team", details: error });
    }
  }
  ...
  public static async updateTeam(req: any, res: any) {
    try {
      ...
      return res
        .status(200)
        .send({ message: "Team updated", data: updatedTeam });
    } catch (error) {
      return res
        .status(500)
        .send({ error: "Failed to update team", details: error });
    }
  }
  ...
  public static async deleteTeam(req: any, res: any) {
    try {
      ...
      return res
        .status(500)
        .send({ error: "Failed to delete team", details: error });
    }
  }
  ...
  public static async addPlayersBulk(req: any, res: any) {
    try {
      ...
      return res
        .status(500)
        .send({ error: "Failed to add players", details: error });
    }
  }
  ...
  public static async addPlayerSingle(req: any, res: any) {
    try {
      ...
      return res
        .status(500)
        .send({ error: "Failed to add player", details: error });
    }
  }
  ...
  public static async removePlayer(req: any, res: any) {
    try {
      ...
      return res
        .status(500)
        .send({ error: "Failed to remove player", details: error });
    }
  }
}
